...
BOTADDLOGS = int(getenv("BOTADDLOGS", "")) # LOGGER_ID Id Also Use No Problem
GBAN_LOGS = int(getenv("GBAN_LOGS", ""))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/bioslen/AnieXEricaMusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN",None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/nein_play")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/nein_play")
